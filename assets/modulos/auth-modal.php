    ...
    <div class="modal-content p-2">
      ...
      <form class="d-flex flex-column align-items-center gap-3" action="#">
        ...
        <div class="d-flex flex-row w-75">
          ...
          <button id="login-showPass" type="button" class="border border-start-0 rounded-end" style="width: 15%">
        ...
        <div>
          Não tenho tenho uma conta, <a class="link-primary" href="javascript:void()">quero me cadastrar!</a>
        </div>
